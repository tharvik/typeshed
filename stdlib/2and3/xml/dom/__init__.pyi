...
class Document(Node):
    ...
    def createAttribute(self, name: str) -> Node: ...
    def createAttributeNS(self, namespaceURI: str,
                          qualifiedName: str) -> Node: ...
...
class Element(Node):
    ...
    def getAttributeNode(self, attrname: str) -> Node: ...
    def getAttributeNS(self, namespaceURI: str, localName: str) -> str: ...
    def getAttributeNodeNS(self, namespaceURI: str, localName: str) -> Node: ...
    def removeAttribute(self, name: str) -> None: ...
    def removeAttributeNode(self, oldAttr: str) -> None: ...
    def removeAttributeNS(self, namespaceURI: str, localName: str) -> None: ...
    def setAttribute(self, name: str, value: str) -> None: ...
    def setAttributeNode(self, newAttr: Node) -> Node: ...
    def setAttributeNodeNS(self, newAttr: Node) -> Node: ...
