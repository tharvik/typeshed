...
from xml.sax.xmlreader import Locator, InputSource
...
class DTDHandler:
    def notationDecl(self, name: str, publicId: str, systemId: str) -> None: ...
    def unparsedEntityDecl(self, name: str, publicId: str, systemId: str,
                           ndata: str) -> None: ...


class EntityResolver:
    def resolveEntity(self, publicId: str,
                      systemId: str) -> Union[str, InputSource]: ...
