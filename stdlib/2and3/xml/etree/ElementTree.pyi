...
def fromstringlist(sequence: Sequence[str],
                   parser: Optional[XMLParser] = ...) -> Element: ...
...
def parse(source: Union[str, IO[str]],
          parser: Optional[XMLParser] = ...) -> ElementTree: ...
...
def XML(text: str, parser: Optional[XMLParser] = ...) -> Element: ...
def XMLID(text: str,
          parser: Optional[XMLParser] = ...) -> Tuple[Element, Mapping[str, Element]]: ...
...
class Element(Iterable[Element], Sized):
    ...
    def extend(self, subelements: Sequence[Element]) -> None: ...
    if sys.version_info >= (3,):
        ...
        def find(self, match: str) -> Optional[Element]: ...
        def findall(self, path: str) -> List[Element]: ...
        # TODO can restrict if default is not defined
        def findtext(self, path: str,
                     default: Optional[_T] = ...) -> Union[str, _T]: ...
...
class XMLParser:
    def __init__(self, html: int = ..., target: Optional[TreeBuilder] = ...,
