...
class Element(Sized):
    ...
    def find(self, match: str,
             namespaces: Optional[Mapping[str, str]] = ...) -> Optional[Element]: ...
    def findall(self, path: str,
                namespaces: Optional[Mapping[str, str]] = ...) -> List[Element]: ...
    # TODO can restrict if default is not defined
    def findtext(self, path: str, default: Optional[_T] = ...,
                 namespaces: Optional[Mapping[str, str]] = ...) -> Union[Element, _T]: ...
    ...
    def iterfind(self, path: str,
                 namespaces: Optional[Mapping[str, str]] = ...) -> Iterator[Element]: ...
